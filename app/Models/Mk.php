...
//    protected $table = ['mks'];
    ...
    protected function getListOfUsersOnMk(){
        return $this->with('user','teacher','mkpic')->get();
    }
    ...
    {
        return $this->belongsToMany(User::class, 'mk_user','mk_id', 'user_id');
    }
...
//fistof create проверяет есть ли запись в базе по дате и если нет то вносит.
